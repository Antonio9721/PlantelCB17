...
<div class="col-12">
	<body>
	<?php foreach ($higienesolito as $key): ?>
		<form action="http://localhost:8084/Plantel/index.php/higiene/updateHigiene/<?=$key->idHigiene?>" 
		method="POST">
		<br> <br> <br>
	<div align="center">
...
<br>
				...
				<input class="form-control" type="text" name="materiap" value="<?=$key->MateriaP ?>">
<br>				
				<label>Materia de Apoyo 2:</label>
				<input class="form-control" type="text" name="materias" value="<?=$key->MateriaS ?>">
			</div>
			<div class="col-6"></div>
			<div class="form-group col-md-4">
