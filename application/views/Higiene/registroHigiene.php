...
<div class="col-12">
	<body>
	<form action="http://localhost:8084/Plantel/index.php/higiene/create" method="POST" onsubmit="return 
	validarFormulario()">
	<div align="center">
	<h4>Capacitación en Higiene y Salud Comuniaria</h4>
...
<br>
				...
				<input id="materiap" class="form-control" type="text" name="materiap" onkeypress="return 
				soloLetras(event)" maxlength="80">
<br>			
				<label>Materia de Apoyo 2:</label>
				<input id="materias" class="form-control" type="text" name="materias" onkeyup="this.value=
				soloLetras(this.value)">
			</div>
			<div class="col-6"></div>
