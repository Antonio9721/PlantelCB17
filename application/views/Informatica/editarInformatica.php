...
<div class="col-12">
	<body>
	<?php foreach ($informaticasolito as $key): ?>
		<form action="http://localhost:8084/Plantel/index.php/informatica/updateInformatica/<?=$key->idInfor?>" 
		method="POST">
		<br> <br> <br>
		<div align="center">
	<h4>Capacitación en Informàtica</h4>
