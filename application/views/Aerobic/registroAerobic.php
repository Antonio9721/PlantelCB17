...
<div class="col-12">
	<body>
	<form action="http://localhost:8084/Plantel/index.php/aerobic/create" method="POST" 
...
<br>				
			...
			<input id="hinicio" class="form-control" type="timestamp" name="hinicio" onkeypress="return soloLetras(event)"
			 maxlength="25">
<br>

			<label>Fin de la Clase:</label>
			<input id="hfin" class="form-control" type="timestamp" name="hfin" onkeypress="return soloLetras(event)"
			 maxlength="25">
