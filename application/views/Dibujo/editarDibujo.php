...
<div class="col-12">
	<body>
	<?php foreach ($dibujosolito as $key): ?>
		<form action="http://localhost:8084/Plantel/index.php/dibujo/updateDibujo/<?=$key->idDibujo?>" 
		method="POST">
		<br> <br> <br>
	<div align="center">
	<h4>Capacitación en Diseño Arquitectònico</h4>
