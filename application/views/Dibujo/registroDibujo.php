...
<div class="col-12">
	<body>
	<form action="http://localhost:8084/Plantel/index.php/dibujo/create" method="POST" onsubmit="return 
	validarFormulario()">
	<div align="center">
...
<br>
				...
				soloLetras(event)" maxlength="60">
<br>
				<label>Materia de Apoyo 2:</label>
				<input id="materia2" class="form-control" type="text" name="materia2" onkeyup="this.value=
