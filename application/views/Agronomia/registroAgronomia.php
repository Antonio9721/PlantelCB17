...
<html>
<head>
	<title>Registro de la Capacitación de Agronomia</title>
</head>
<div class="col-12">
	<body>
	<form action="http://localhost:8084/Plantel/index.php/agronomia/create" method="POST" 
	onsubmit="return validarFormulario()">
		<div align="center">
		<h4>Capacitación en Producción Agropecuaria</h4>
...
<br>
				...
				soloLetras(event)" onkeyup="this.value=Mayusculas(this.value)" maxlength="50" minlength="1">
<br>
...
<br>				
			...
			<input id="materia1" class="form-control" type="text" name="materia1" onkeypress="return soloLetras(event)"
			 maxlength="50">
<br>

			<label>Materia de Apoyo 2:</label>
			<input id="materia2" class="form-control" type="text" name="materia2" onkeypress="return soloLetras(event)"
			 maxlength="50">
