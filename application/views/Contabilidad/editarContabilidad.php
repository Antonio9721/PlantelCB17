...
<div class="col-12">
	<body>
		<?php foreach ($contabilidadsolita as $key): ?>
	<form action="http://localhost:8084/Plantel/index.php/contabilidad/updateContabilidad/<?=$key->idConta?>" 
	method="POST">
	<br> <br> <br>
		<div align="center">
		<h4>Capacitación de Contabilidad</h4>
		<h5>Editar el Registro del Alumno</h5>
		</div>
