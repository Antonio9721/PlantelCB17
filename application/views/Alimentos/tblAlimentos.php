...
<html>
<head>
	<title>Tecnología de los Alimentos</title>
</head>
<body>
	<div>
		<div align="center">
		...
		<div class="col-2" align="left">
			<a href="http://localhost:8084/Plantel/index.php/alimentos/opencreate">
		...
		<div class="card-body">
			 <tr class="table-secondary">
				<table class="table " id="example1" width="100%" cellspacing="0">
					...
					<tbody>
						<?php foreach ($datosAlimentos as $key):?>
							<tr>
								<td><?=$key->idAlim ?></td>
								<td><?=$key->Nombre ?></td>
								<td><?=$key->ApellidoP ?></td>
								...
								<a href="http://localhost:8084/Plantel/index.php/alimentos/findone/<?=$key->idAlim ?>">
								<button class="form-control btn btn-success" onclick="return Edition()">Editar</button></a>
								</td>
								<td>
								<a href="http://localhost:8084/Plantel/index.php/alimentos/delete/<?=$key->idAlim ?>">
